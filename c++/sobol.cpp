...
//
  float temp;
  array<double, 1> quasi(dim_num);
  quasi() = 0;
  for ( i = 0; i < dim_num; i++ )
  {
    temp = ( ( float ) lastq[i] ) * recipd;  // Marjan: Maybe there is some voodoo conversion from int to float and int to double won't work directly.
    quasi(i) = (double) temp;
...
//
//    Output, double R4_UNIFORM_01, a new pseudorandom variate, strictly between
//    0 and 1.
//
{
  int k;
