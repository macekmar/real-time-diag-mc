...
dcomplex insert::attempt() {
 ...
 sum_dets = recompute_sum_keldysh_indices(weight->matrices[up], weight->matrices[down], k + 1);
...
dcomplex insert2::attempt() {
 ...
 sum_dets = recompute_sum_keldysh_indices(weight->matrices[up], weight->matrices[down], k + 2);
...
dcomplex remove::attempt() {
 ...
 sum_dets = recompute_sum_keldysh_indices(weight->matrices[up], weight->matrices[down],
                                          k - 1); // recompute sum over keldysh indices
...
dcomplex remove2::attempt() {
 ...
 sum_dets =
     recompute_sum_keldysh_indices(weight->matrices[up], weight->matrices[down], k - 2); // recompute sum over keldysh indices
...
dcomplex shift::attempt() {
 ...
 sum_dets = recompute_sum_keldysh_indices(weight->matrices[up], weight->matrices[down], k);
