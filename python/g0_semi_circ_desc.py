...
""")
module.add_function ("gf_view<refreq> make_g0c_semi_circular_freq (double beta, double Gamma, double tmax_gf0, int Nt_gf0, double epsilon_d, double muL, double muR)", doc = """""")
