...
if mpi.is_master_node():
    with HDFArchive('density10k.out.h5', 'a') as ar:  # A file to store the results
        ar['pn_values'] = pn
...
with HDFArchive('density10k.ref.h5', 'r') as ar:
    print "sn out:", sn[:, 1]
...
h5diff("density10k.out.h5","density10k.ref.h5")
